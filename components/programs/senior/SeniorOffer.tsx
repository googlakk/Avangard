        ...
        <section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            <div className="container mx-auto relative z-10 pt-28 pb-20 pl-8 md:pl-16 lg:pl-24 xl:pl-32 pr-4">
                <div className="max-w-[560px]">
                    ...
                    {/* Main Headline */}
                    <h1
                        className="mb-10 font-display opacity-0 animate-[fadeIn_0.8s_ease-out_0.4s_forwards]"
                        style={{
                    ...
                    {/* Description */}
                    <p
                        className="mb-10 text-lg leading-relaxed max-w-md opacity-0 animate-[fadeInUp_0.8s_ease-out_0.5s_forwards]"
                        style={{
                            color: 'rgba(255,255,255,0.85)',
                            letterSpacing: '0.01em'
                        }}
                    >
                        Двухлетняя академическая программа с персональным сопровождением до поступления.
                    </p>
