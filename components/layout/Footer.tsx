                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link href="/teachers/culture" className="text-gray-400 hover:text-white transition-colors duration-300 hover:translate-x-1 inline-block">
                                    {t.header.teachers}
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            ...
                            <li className="flex items-start space-x-3">
                                ...
                                <a href="mailto:info@intellect.edu.kg" className="text-gray-400 hover:text-white transition-colors">
                                    info@intellect.edu.kg
                                </a>
                            </li>
                        </ul>
                    </div>
