...
const FAQS = [
    ...
    {
        question: "Есть ли в школе продленка?",
        answer: "Да, школа работает в режиме полного дня с 8:30 до 18:00. После основных уроков дети посещают кружки, секции, делают домашнее задание под присмотром тьюторов и отдыхают."
    },
    {
